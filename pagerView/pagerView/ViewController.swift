...
class ViewController: UIViewController, FSPagerViewDataSource, FSPagerViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.leftBt.layer.cornerRadius = self.leftBt.frame.height/2
        self.rightBt.layer.cornerRadius = self.rightBt.frame.height/2
...
//        cell.textLabel?.text = ...
    ...
    @IBAction func rightClicked(_ sender: UIButton) {
        print("ViewController - rightclicked()")
    ...
    @IBAction func leftClicked(_ sender: UIButton) {
        print("ViewController - leftclicked()")
